...
One-shot: `Простыми словами: Проверили 36 сообщений на лиды. Точность не измерена: сервис сломал один ответ, поэтому классификатор не трогали. Дальше — починить ответ и повторить 36. От тебя ничего.`
</style>
